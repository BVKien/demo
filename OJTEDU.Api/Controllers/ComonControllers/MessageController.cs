    ...
    public class MessageController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateFirstMessageConversation(int? userId, int? receiverId, CreateFirstMessageConversationInput? input)
        {
            try
            {
                ...
                var apiResponse = await _messageService.CreateFirstMessageConversationAsync(userId, receiverId, input?.MessageFile, input?.Image, messageInfoDto);
        ...
        public async Task<IActionResult> CreateMessage(int? userId, CreateMessageInput? input)
        {
            try
            {
                ...
                var apiResponse = await _messageService.CreateMessageAsync(userId, input?.MessageFile, input?.Image, messageInfoDto);
